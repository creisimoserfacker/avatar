...
NDiplomacy = {
	...
	TENSION_DECAY = 0,								-- Each months tension decays this much
...
NResistance = {
	INITIAL_STATE_RESISTANCE = 25.0,						-- initial resistance percentage of a state once it is captured
	...
	SUPPRESSION_NEEDED_BY_RESISTANCE_POINT = 1.5, -- Number of suppression point we need for each 1% of resistance
...
NMilitary = {
	...
	LAND_COMBAT_ORG_ARMOR_ON_SOFT_DICE_SIZE = 16,   -- extra damage dice if our armor outclasses enemy
	LAND_COMBAT_STR_ARMOR_DEFLECTION_FACTOR = 0.5, -- % damage taken if armor outclassing enemy
	LAND_COMBAT_ORG_ARMOR_DEFLECTION_FACTOR = 0.1, -- % damage taken if armor outclassing enemy
...
NAI = {
	...
	BUILDING_TARGETS_BUILDING_PRIORITIES = {				-- buildings in order of pirority when considering building targets strategies. First has the greatest priority, omitted has the lowest. NOTE: not all buildings are supported by building targets strategies.
		'farm', 'lumber_mill', 'carpentry', 'mine', 'quarry', 'industrial_complex',
	},
...
NSupply = {
	...
	CAPITAL_SUPPLY_CIVILIAN_FACTORIES = 0.4, -- supply from one civilian factory
	...
	VP_TO_SUPPLY_BONUS_CONVERSION = 0.1,  --0.05,			-- Bonus to supply local supplies from Victory Points, multiplied by this aspect and rounded to closest integer
	...
	NUMBER_OF_SHOWN_SUPPLY_SOURCES_IN_SUPPLY_MAPMODE = 7, -- number of supply flow sources shown in breakdown tooltip
