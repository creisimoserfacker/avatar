...
NCountry = {
	...
	SUPPLY_BONUS_FROM_INPUT = 0.5,					-- % of supply bonus from input area.
	...
	AUTONOMOUS_TOTAL_SCORE = 100000,					-- Total score for autonomous scale
	...
	SPECIAL_FORCES_CAP_MIN = 10,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NProduction = {
	...
	BASE_FACTORY_SPEED_MIL = 20, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NMilitary = {
	...
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.006,        -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.006,        -- global damage modifier
	...
	LAND_COMBAT_ORG_ARMOR_ON_SOFT_DICE_SIZE = 24,   -- extra damage dice if our armor outclasses enemy
	LAND_COMBAT_STR_ARMOR_DEFLECTION_FACTOR = 0.5, -- % damage taken if armor outclassing enemy
	LAND_COMBAT_ORG_ARMOR_DEFLECTION_FACTOR = 0.25, -- % damage taken if armor outclassing enemy
	LAND_COMBAT_COLLATERAL_FACTOR = 0.005,		   -- Factor to scale collateral damage to infra and forts with.
	LAND_COMBAT_FORT_DAMAGE_CHANCE = 0.5,		-- chance to get a hit to damage on forts. (out of 100)
	...
	EXPERIENCE_LOSS_FACTOR = 10.00,                 -- percentage of experienced solders who die when manpower is removed
	...
	SUPPLY_GRACE = 168,							   -- troops always carry 7 days of food and supply
	...
	COMBAT_STACKING_EXTRA = 9,                      -- extra stacking from directions
...
NAir = {
	...
	COMBAT_BETTER_AGILITY_DAMAGE_REDUCTION = 0.5, 		-- How much the better agility (then opponent's) can reduce their damage to us.
...
NNavy = {
	...
	AGGRESSION_TORPEDO_EFFICIENCY_ON_HEAVY_SHIPS = 1.2,   -- ratio for scoring for different gun types against heavy ships
...
NAI = {
	...
	PLAN_VALUE_TO_EXECUTE = 0.0,				-- AI will typically avoid carrying out a plan it below this value (0.0 is considered balanced).
