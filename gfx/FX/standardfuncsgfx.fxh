...
PixelShader = 
{
	...
	static const float GMT_OFFSET = 0.0f; // X position on map, of Greenwitch GMT+0
	...
	static const float SOUTH_POLE_OFFSET = 0.15f; // Our map is missing big parts of globe on north and south
	static const float NORTH_POLE_OFFSET = 0.85f;
